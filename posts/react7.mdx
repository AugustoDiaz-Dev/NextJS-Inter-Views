...
tags:
  - react
date: "2022-07-07"
excerpt: React. Reselect. Flow and PropTypes. React DevTools. font-awesome. Polymer. Styled-components. Relay. TypeScript. Vue. Angular.
---
...
| No. | Questions |  
| --- | --------- |  
|001| [What is reselect and how it works?](#what-is-reselect-and-how-it-works) |
|002| [What is Flow?](#what-is-flow) |
|003| [What is the difference between Flow and PropTypes?](#what-is-the-difference-between-flow-and-proptypes) |
|004| [How to use font-awesome icons in React?](#how-to-use-font-awesome-icons-in-react) |
|005| [What is React Dev Tools?](#what-is-react-dev-tools) |
|006| [Why is DevTools not loading in Chrome for local files?](#why-is-devtools-not-loading-in-chrome-for-local-files) |
|007| [How to use Polymer in React?](#how-to-use-polymer-in-react) |
|008| [What are the advantages of React over Vue.js?](#what-are-the-advantages-of-react-over-vuejs) |
|009| [What is the difference between React and Angular?](#what-is-the-difference-between-react-and-angular) |
|010| [Why React tab is not showing up in DevTools?](#why-react-tab-is-not-showing-up-in-devtools) |
|011| [What are styled components?](#what-are-styled-components) |
|012| [Give an example of Styled Components?](#give-an-example-of-styled-components) |
|013| [What is Relay?](#what-is-relay) |
|014| [How to use TypeScript in create-react-app application?](#how-to-use-typescript-in-create-react-app-application) |
</div>
<br/>
<hr/>
    
001. ## What is reselect and how it works?
...
003. ## What is the difference between Flow and PropTypes?
...
004. ## How to use Font Awesome icons in React?
...
006. ## Why is DevTools not loading in Chrome for local files?
...
007. ## How to use Polymer in React?
...
008. ## What are the advantages of React over Vue.js?
...
009. ## What is the difference between React and Angular?
...
010. ## Why React tab is not showing up in DevTools?
...
011. ## What are Styled Components?

`styled-components` is a JavaScript library for styling React applications. It removes the mapping between styles and components, and lets you write actual CSS augmented with JavaScript.

**[<span style={{color: "var(--myLightBlue)"}}>⬆ Back to Top</span>](#contents)**
    
012. ## Give an example of Styled Components?
...
014. ## How to use TypeScript in `create-react-app` application?
